...
public:
     ...
     **************************************************************************************************/
    static AnimatedSprite* CreateAnimatedSprite(const std::string& name, BITMAP* file, double frameRate);
...
protected:
     ...
     **************************************************************************************************/
    AnimatedSprite(const std::string& name, BITMAP* file, double frameRate);
