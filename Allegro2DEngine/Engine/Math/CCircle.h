...
public:
     ...
     **************************************************************************************************/
    Circle(double x, double y,  double radius, const ALLEGRO_COLOR& color, bool filled);
     ...
     * <param name="filled">true to filled.</param>
     **************************************************************************************************/
    Circle(const Vector2D& center, double radius, const ALLEGRO_COLOR& color, bool filled);
