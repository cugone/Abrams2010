...
public:
     ...
     **************************************************************************************************/
    Polygon(const std::vector<a2de::Vector2D>& points, const a2de::Color& color, bool filled);
     ...
     **************************************************************************************************/
    const std::vector<a2de::Vector2D>& GetVertices() const;
     ...
     * <returns>The vertices.</returns>
     **************************************************************************************************/
    std::vector<a2de::Vector2D>& GetVertices();
