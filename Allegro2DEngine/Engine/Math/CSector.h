...
public:
     ...
     **************************************************************************************************/
    Sector(const Vector2D& position, double startAngle, double endAngle, double radius, const a2de::Color& color, bool filled);
     ...
     * <param name="filled">    true to filled.</param>
     **************************************************************************************************/
    Sector(double x, double y, double startAngle, double endAngle, double radius, const a2de::Color& color, bool filled);
...
namespace {
    std::vector<a2de::Vector2D> _fill_points;

    /**************************************************************************************************
     * <summary>Helper to create triangle fan</summary>
     * <remarks>Casey Ugone, 2/25/2014.</remarks>
     * <param name="dest">[in,out] If non-null, destination for the.</param>
     * <param name="x">   The x coordinate.</param>
     * <param name="y">   The y coordinate.</param>
     * <param name="c">   The int to process.</param>
     **************************************************************************************************/
    void DoArcHelper(BITMAP* dest, int x, int y, int c);
}
